...
# from mcloader import ClassificationDataset  # Comment out if not available
from custom_food_dataset import FoodDataset
...
def build_dataset(is_train, args):
    ...
    if args.data_set == 'CIFAR':
        ...
        # Custom Food Dataset
        csv_file = os.path.join(args.data_path, 'train.csv' if is_train else 'test.csv')
